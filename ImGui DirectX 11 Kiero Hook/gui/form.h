...
public:
	...
	__forceinline Rect GetTabsRect( ) const {
		return { m_x + 15, m_y + 55, 155, m_height - 55 };
	}

	__forceinline Rect GetElementsRect( int scroll_pos ) const {
		return { m_x + 170, m_y + 80 - scroll_pos, 450, m_height - 55 };
	}
